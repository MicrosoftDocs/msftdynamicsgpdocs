---
title: "Canadian Payroll 2018 Year-end Update & 2019 Tax Update"
description: "Canadian Payroll 2018 Year-end Update & 2019 Tax Update"
keywords: "year-end"
author: theley502
manager: edupont
...
*Chapter 4, "Tax updates,"* describes the federal and provincial or territorial tax changes for 2019.

### What’s changed

The 2018 Year-End Update/2019 Tax Update contains changes in the information that’s submitted to the Canada Revenue Agency (CRA) and Ministère du Revenu du Québec.
...
The 2018 Year-End Update/2019 Tax Update contains application bug fixes and functionality updates to comply with regulatory changes.

#### XML and form changes

The T4A, T4 and RL-1 XML has changed for the 2018 reporting year. The T4 forms have not changed for the 2018 reporting year.  
...
RL-1 Slip Authorization number FS1801188  (enter in the Payroll T4/R1 Print window)  

#### Installation notes

The 2019 Canadian Payroll Tax Update must be installed on the server and on each client workstation where Microsoft Dynamics GP is used. Before installing the update, be sure to complete the following tasks:
...
| 8.       | Make a backup of your data titled “Post 2018 Year-End Update.”\*|
...
The 2018 Year-End Update / 2019 Tax Update supports Microsoft Dynamics GP 2018, Microsoft Dynamics GP 2016, and Microsoft Dynamics GP 2015. To identify the Microsoft Dynamics GP release you’re using, start the application and choose Help \>\> About Microsoft Dynamics GP.
...
Effective January 1, 2019 the federal tax rate is unchanged. The federal index factor is 1.022. The income thresholds are revised as follows.

![](media/42ebd1be6b4c08905a6f4e6f227e3ffa.png)

### Federal personal amounts

Federal personal amounts have been increased by fixed amounts as shown in the following table.

The Basic Personal amount is updated to \$12,069 (formerly \$11,809).

The Spouse Common Law Partner amount increases by the index factor to \$12,069 (formerly \$11,809), if the original amount was not zero.

The Eligible Dependent amount increases by the index factor to \$12,069 (formerly \$11,809), if the original amount was not zero.
...
The following provinces and territories have tax changes for 2019.
...
![](media/8c70bc2d5deef913af861abbeb9a0f6c.png)
...
- There is no index factor in PEI, but the personal amount is changed to \$9,160 from \$8,160.  
- The Spouse or Common-law Partner and Eligible Dependent is \$7,780.

![](media/a4468528be0cb1279552ac57075426b0.png)

#### Quebec

The TP-1015.3-V Basic amount increases by the index factor and is usually revised to \$15,269 (formerly \$15,012). The system rounds this calculation to the nearest \$5.00

![](media/2b8973e411c454b40a693d90ae16fcb5.png)

#### Variable H – Deduction for employment income

The deduction for Employment income has been increased to \$1,170, formerly \$1,150. Therefore, the deduction is now the lesser of 6% of employment income or \$1,170.
...
> [!NOTE]
> An amount listed as 1.006 means that the index factor is 6%.

| **Taxing authority**      | **2019 index factor** | **2018 index factor** |
|---------------------------|-----------------------|-----------------------|
| Federal                   | 1.022                 | 1.015                 |
| Alberta                   | 1.024                 | 1.012                 |
| British Columbia          | 1.026                 | 1.020                 |
| Manitoba                  | 1.026                 | 1.012                 |
| New Brunswick             | 1.022                 | 1.015                 |
| Newfoundland and Labrador | 1.018                 | 1.030                 |
| Northwest Territories     | 1.022                 | 1.015                 |
| Nova Scotia               | 1.000                 | 1.000                 |
| Nunavut                   | 1.022                 | 1.015                 |
| Ontario                   | 1.022                 | 1.018                 |
| Prince Edward Island      | 1.000                 | 1.000                 |
| Quebec                    | 1.0171                | 1.0082                |
| Saskatchewan              | 1.000                 | 1.014                 |
| Yukon                     | 1.022                 | 1.015                 |
