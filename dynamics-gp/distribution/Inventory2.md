...
a.	Run the below scripts to ‘clean’ up the Inventory tables:
...
b.	Run an Inventory Reconcile to update the allocated quantities. Do not skip this step.

c.	You should now be able to transfer any quantities from the Via site to the To site that have not already been transferred. 
