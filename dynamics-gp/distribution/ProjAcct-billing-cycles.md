...
**NOTE** You can use the Time and Materials Billing Inquiry window (Inquiry > Project > PA Transaction Documents > T&M Billing) to view billing invoice line item details for Time and Materials projects.
...
1.	Open the Progress Billing Entry window.  Transactions > Project > Billing > Billing Entry > select a Cost Plus or Fixed Price project > Billings expansion button
...
You can click the Tax expansion button to modify tax details for the tax schedule for the cost category.
...
1.	Open the Billable Fees window.   Transactions > Project > Billing > Billing Entry > Fees field > select a Project Number > Fees expansion button
...
1.	Open the Billing Commissions window.  Transactions > Project > Billing > Billing Entry > Commissions button
...
9.	In the Rtn column, select the check box for line items to return. Click Return All
or Do Not Return All to select or clear all check boxes.
...
4.	Select the billing format to use.

•	Select a billing format and select Override to use that billing format instead of the billing formats that have been assigned to the customers, contracts, or projects that the billing invoices are for.
...
1.	Open the Apply Sales Documents window.   Transactions > Sales > Apply Sales Documents
