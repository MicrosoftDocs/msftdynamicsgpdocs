...
There are various tools and processes available for synchronizing logins in an AlwaysOn Availability Group. You will want to review the SQL Server documentation or reach out to the SQL Server team via a support case or their community forums if you need assistance with setting this up.
