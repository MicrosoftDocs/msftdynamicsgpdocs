...
![Diagram of scenario 3 showing how credentials are passed with a client work station and two servers, one of which is a Microsoft SharePoint Server 2010 or SharePoint Foundation 2010 or later.](media/KERB3.jpg)
...
1. First, you need to find the accounts that are running the services involved in the process of displaying the SQL Server Reporting Services reports:
    ...
    ![Screenshot of the Reporting Services Configuration Manager SQL/GP window.](media/KERB5.jpg)
